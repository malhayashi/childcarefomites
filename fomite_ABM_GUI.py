...
class New_Toplevel_1:
    def __init__(self, top=None):
        ...
        top.geometry("606x450+629+134")
        top.title("Stochastic SIWR GUI")
        ...
        self.Label1.place(relx=0.03, rely=0.04, height=18, width=104)
        self.Label1.configure(activebackground="#f9f9f9")
        self.Label1.configure(text='''Contact Rate HH''')

        self.Label4 = Label(top)
        self.Label4.place(relx=0.02, rely=0.22, height=18, width=126)
        self.Label4.configure(activebackground="#f9f9f9")
        self.Label4.configure(text='''Face Touch Rate''')

        self.Label5 = Label(top)
        self.Label5.place(relx=0.05, rely=0.18, height=18, width=96)
        self.Label5.configure(activebackground="#f9f9f9")
        self.Label5.configure(text='''Transfer FR''')

        self.Label6 = Label(top)
        self.Label6.place(relx=0.07, rely=0.27, height=18, width=66)
        self.Label6.configure(activebackground="#f9f9f9")
        self.Label6.configure(text='''INF Prob''')

        self.Label7 = Label(top)
        self.Label7.place(relx=0.0, rely=0.31, height=18, width=106)
        self.Label7.configure(activebackground="#f9f9f9")
        self.Label7.configure(text='''Wash Rate''')

        self.Label8 = Label(top)
        self.Label8.place(relx=0.05, rely=0.36, height=18, width=126)
        self.Label8.configure(activebackground="#f9f9f9")
        self.Label8.configure(text='''Incubation Rate''')

        self.Label9 = Label(top)
        self.Label9.place(relx=0.0, rely=0.4, height=18, width=136)
        self.Label9.configure(activebackground="#f9f9f9")
        self.Label9.configure(text='''Recovery Rate''')

        self.Label10 = Label(top)
        self.Label10.place(relx=0.05, rely=0.44, height=18, width=116)
        self.Label10.configure(activebackground="#f9f9f9")
        self.Label10.configure(text='''Shedding Rate''')

        self.Label11 = Label(top)
        self.Label11.place(relx=0.0, rely=0.49, height=18, width=106)
        self.Label11.configure(activebackground="#f9f9f9")
        self.Label11.configure(text='''Shedding''')

        self.Label12 = Label(top)
        self.Label12.place(relx=0.03, rely=0.53, height=18, width=86)
        self.Label12.configure(activebackground="#f9f9f9")
        self.Label12.configure(text='''Dieoff''')

        self.Label13 = Label(top)
        self.Label13.place(relx=0.0, rely=0.58, height=18, width=116)
        self.Label13.configure(activebackground="#f9f9f9")
        self.Label13.configure(text='''Day Length''')

        self.Entry1 = Entry(top)
        self.Entry1.place(relx=0.3, rely=0.04, relheight=0.04, relwidth=0.24)
        self.Entry1.configure(background="white")
        self.Entry1.configure(font="TkFixedFont")
        self.Entry1.configure(selectbackground="#c4c4c4")

        self.Entry2 = Entry(top)
        self.Entry2.place(relx=0.33, rely=0.09, relheight=0.04, relwidth=0.24)
        self.Entry2.configure(background="white")
        self.Entry2.configure(font="TkFixedFont")
        self.Entry2.configure(selectbackground="#c4c4c4")

        self.Entry3 = Entry(top)
        self.Entry3.place(relx=0.3, rely=0.13, relheight=0.04, relwidth=0.24)
        self.Entry3.configure(background="white")
        self.Entry3.configure(font="TkFixedFont")
        self.Entry3.configure(selectbackground="#c4c4c4")

        self.Entry4 = Entry(top)
        self.Entry4.place(relx=0.33, rely=0.18, relheight=0.04, relwidth=0.24)
        self.Entry4.configure(background="white")
        self.Entry4.configure(font="TkFixedFont")
        self.Entry4.configure(selectbackground="#c4c4c4")

        self.Entry5 = Entry(top)
        self.Entry5.place(relx=0.3, rely=0.22, relheight=0.04, relwidth=0.24)
        self.Entry5.configure(background="white")
        self.Entry5.configure(font="TkFixedFont")
        self.Entry5.configure(selectbackground="#c4c4c4")

        self.Entry6 = Entry(top)
        self.Entry6.place(relx=0.33, rely=0.27, relheight=0.04, relwidth=0.24)
        self.Entry6.configure(background="white")
        self.Entry6.configure(font="TkFixedFont")
        self.Entry6.configure(selectbackground="#c4c4c4")

        self.Entry7 = Entry(top)
        self.Entry7.place(relx=0.3, rely=0.31, relheight=0.04, relwidth=0.24)
        self.Entry7.configure(background="white")
        self.Entry7.configure(font="TkFixedFont")
        self.Entry7.configure(selectbackground="#c4c4c4")

        self.Entry8 = Entry(top)
        self.Entry8.place(relx=0.33, rely=0.36, relheight=0.04, relwidth=0.24)
        self.Entry8.configure(background="white")
        self.Entry8.configure(font="TkFixedFont")
        self.Entry8.configure(selectbackground="#c4c4c4")

        self.Entry9 = Entry(top)
        self.Entry9.place(relx=0.3, rely=0.4, relheight=0.04, relwidth=0.24)
        ...
        self.Entry10.place(relx=0.33, rely=0.44, relheight=0.04, relwidth=0.24)
        ...
        self.Entry11.place(relx=0.3, rely=0.49, relheight=0.04, relwidth=0.24)
        ...
        self.Entry12.place(relx=0.33, rely=0.53, relheight=0.04, relwidth=0.24)
        ...
        self.Entry13.place(relx=0.3, rely=0.58, relheight=0.04, relwidth=0.24)
...
def but3Press():
    try:
        ...
        iterator = 0
        for k in parameters:
            parameters[k] = float(top.entries[iterator])
            iterator += 1
        gen()
    except:
        tkMessageBox.showinfo('Error!','Unfilled parameters!')
...
def gen():
    from fomite_ABM_GUI import Agent, Fomite
